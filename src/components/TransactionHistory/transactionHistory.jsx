import { TbodyTransactionHistory, TdElem, ThTitleElem, TheadTransactionHistory, Row, TransactionHistoryEl } from "./transactionHistory.styled"

export const TransactionHistory = ({ items }) => {
    return <TransactionHistoryEl>
